...
class AmazonScraper {
    ...
    get userAgent() {
        {
            //return `Mozilla/5.0 (Linux; Android 10; HD1903) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.93 Mobile Safari/537.36`;
            const os = [
    ...
    async buildRequest(page) {
        ...
        try {
            ...
            /*let fileName = 'req_' + this.scrapeType + Math.random() + '.html';

            console.log('34322response written to ', fileName);
    ...
    grabReviews(body) {
        ...
        //console.log("$('#cm_cr-review_list')[0].children", $('#cm_cr-review_list')[0].children);
        let scrapingResult = {};
